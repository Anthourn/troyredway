...
const Projects = () => {
    return(
        ...
        <div id = 'iron man' className = 'card' style={{backgroundImage: `url("https://geekireland.com/wp-content/uploads/2019/05/Avengers-logo-game.jpg")`}} >
       ...
       <a href = 'https://blooming-taiga-25990.herokuapp.com/' className = 'button'>Live</a>
       </div>

       </div>

       <div id = 'iron man' className = 'card' style={{backgroundImage: `url("https://pm1.narvii.com/7104/f1e0477e989ff43607193360191c0084820140d7r1-1241-704v2_hq.jpg")`}} >
       <div className = 'card-content'>
       ...
       <a href = 'https://nxt-big-thing.herokuapp.com/guns' className = 'button'>Live</a>
       <a href = 'https://github.com/Anthourn/Proj2' className = 'button'>Repo</a>
       </div>
       </div>
