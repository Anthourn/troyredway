  ...
  <div class="carousel-inner" >
    <div class="carousel-item active">
      ...
      <div class="carousel-caption  d-md-block">
        <h5 className='d-md-block d-none' style={{color:'white'}}>Movies -> comics</h5>
        <p className='d-md-block d-none' style={{color:'black'}}>Create a library of comic books, using Marvel API for data, Express back end, React Frontend, firebase  auth, MongoDB database storage </p>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption  d-md-block">
        <h5 className= 'd-md-block d-none' style={{color:'black'}}>Spamazon</h5>
        <p className='d-md-block d-none' style={{color:'black'}}>Shopping app created in collaborration, using D'jango back end, React front end, PostgreSQL data storage Firebase Auth(items may take a few moments to load)</p>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption  d-md-block">
        <h5 className='d-md-block d-none' style={{color:'black'}}>Apex guide</h5>
        <p className='d-md-block d-none' style={{color:'black'}}>Basic Wiki using JS, Express, EJS and MongoDB</p>
